...
public class BasePage {
	...
	public void selecionarDataInicioFim(int diaInicio, int diaFim) {
		clicar(By.xpath("//div//div[@data-qa='datepickerInput'][@tabindex='0']"));
		...
		clicar(By.xpath("(//div[@class='datepicker__month-day'][text()='" + inserirDiaInicio + "'])[1]"));
		sleep(1);
		clicar(By.xpath("(//div[@class='datepicker__month-day'][text()='" + inserirDiaFim + "'])[1]"));
