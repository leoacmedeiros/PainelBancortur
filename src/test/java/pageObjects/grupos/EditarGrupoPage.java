...
public class EditarGrupoPage extends BasePage {
	...
	public void clicaEditar() {
		sleep(2);
		clicar(By.xpath("(//td[contains(text(),'Salvador/BA')]//parent::tr//button[contains(text(),'Editar')])[1]"));
	}
	...
	public void selecionaDataInicio(int diaInicio) {
		...
		clicar(By.xpath("//label[contains(text(),'Data Início')]//parent::div//button"));
	...
	*/
	...
	public void escreveContaContabil(String contaContabil) {
		limparTexto(By.xpath("//div//label[contains(text(),'Conta Contábil')]//parent::div//input"));
	...
	public void escreveObsClientes(String ObsClientes) {
		sleep(1);
		clicar(By.xpath("(//div[@class='ql-editor'])[1]"));
		limparTexto(By.xpath("(//div[@class='ql-editor'])[1]"));
	...
	public void escreveAlertaVendedor(String alertaVendedor) {
		...
		clicar(By.xpath("(//div[@class='ql-editor'])[2]"));
		limparTexto(By.xpath("(//div[@class='ql-editor'])[2]"));
		escrever(By.xpath("(//div[@class='ql-editor ql-blank'])[1]"), alertaVendedor);
		
	}

	public void escreveProgramacao(String programacao) {
		clicar(By.xpath("(//div[@class='ql-editor'])[3]"));
		limparTexto(By.xpath("(//div[@class='ql-editor'])[3]"));
	...
	public void escreveItensInclusos(String itensInclusos) {
		...
		clicar(By.xpath("(//div[@class='ql-editor'])[4]"));
		limparTexto(By.xpath("(//div[@class='ql-editor'])[4]"));
		escrever(By.xpath("(//div[@class='ql-editor ql-blank'])[1]"), itensInclusos);
		
	}

	public void escrevePDVsApogeu() {
...
//		clicar(By.xpath("//label[contains(text(),'PDVs Apogeu')]//parent::div//button[text()='Adicionar']"));
		clicar(By.xpath("//label[contains(text(),'PDVs Apogeu')]//parent::div//button[text()='Adicionar Todos']"));
		
	}

	public void validarMensagemSucesso() {
		esperarElementoFicarVisivel2(By.xpath("//div[contains(text(),'Salvo com sucesso')]"));		
		String texto = obterTexto(By.xpath("//div[contains(text(),'Salvo com sucesso')]")).substring(2,15);
		System.out.println("Texto sucesso:" + texto);		
		Assert.assertEquals("Salvo com sucesso".substring(2, 15), obterTexto(By.xpath("//div[contains(text(),'× Salvo com sucesso')]")).subSequence(2,15));
	}	
	...
	public void escreveValorImpostoRemessa(String valorImpostoRemessa) {
		escrever(By.name("ValorImpostoRemessa"), valorImpostoRemessa);
	}
	...
	// 3 etapa
	public void selecionaEditarServicoHotel() {
		clicar(By.xpath("(//tr//td[contains(text(),'Hotel')]//parent::tr//button[contains(text(),'Editar')])[1]"));
	}
	...
	*/
	...
	public void selecionaQuartoRegraTarifaria(String quartoRegraTarifaria) {
		clicar(By.xpath("(//button[contains(text(),'Editar')])[1]"));
	...
	//editar serviço receptivo
	public void selecionaEditarServicoReceptivo() {
		clicar(By.xpath("(//tr//td[contains(text(),'Receptivo')]//parent::tr//button[contains(text(),'Editar')])[1]"));
	}

	public void escreveFornecedorReceptivo(String fornecedorReceptivo) {
		escrever(By.xpath("//label[contains(text(),'Buscar')]//parent::div//input[@placeholder='CNPJ ou Razão Social']"), fornecedorReceptivo);
		clicar(By.xpath("//span//strong[contains(text(),'"+fornecedorReceptivo+"')]"));
	}
